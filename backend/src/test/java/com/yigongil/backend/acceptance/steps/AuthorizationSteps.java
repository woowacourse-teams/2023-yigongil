...
public class AuthorizationSteps {
    ...
    public void 토큰_리프레시(String githubId) throws JsonProcessingException {
        RefreshTokenRequest request = new RefreshTokenRequest(sharedContext.getRefresh(githubId));
    ...
    public void 토큰_탈취(String thief, String victim) throws JsonProcessingException {
        RefreshTokenRequest request = new RefreshTokenRequest(sharedContext.getRefresh(victim));
